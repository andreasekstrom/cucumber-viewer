...
exports.features = (req, res) ->
  ...
  product.findFeatures (features) ->
    res.render 'features', title: 'Documentation - features', product: product, features: features, all: Product.all()
  ...
  product.findFeatures (features) ->
    ...
    if feature?
      feature.readContents (contents) ->
        res.render 'feature', title: 'Feature - ' + feature.name, product: product, feature: contents || "", features: features, all: Product.all()
    else
